...
class ProxyManager {
  ...
  writeEnvConfig(tmp0) {
    ...
    const fn = (arg0, arg1) => {
      ...
      tmp6.push(arg0 + "CONTEXT_WINDOW=" + (tmp0[arg0 + "CONTEXT_WINDOW"] || ""));
    };
  ...
  buildRuntimeConfigPatch(tmp0) {
    const tmp1 = {
      ...
      BYOK1_CONTEXT_WINDOW: tmp0.BYOK1_CONTEXT_WINDOW || "",
      ...
      BYOK2_CONTEXT_WINDOW: tmp0.BYOK2_CONTEXT_WINDOW || "",
      ...
      BYOK3_CONTEXT_WINDOW: tmp0.BYOK3_CONTEXT_WINDOW || "",
      ...
      BYOK4_CONTEXT_WINDOW: tmp0.BYOK4_CONTEXT_WINDOW || "",
